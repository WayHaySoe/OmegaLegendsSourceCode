...
arc21_CFLAGS = -fobjc-arc
arc21_CCFLAGS = -std=c++11 -fno-rtti -fno-exceptions -DNDEBUG
...
arc21_FILES = Tweak.xm $(MENU_SRC) $(KITTYMEMORY_SRC) $(SCLALERTVIEW_SRC)

arc21_LIBRARIES += substrate

arc21_FRAMEWORKS = $(PROJ_COMMON_FRAMEWORKS)
# GO_EASY_ON_ME = 1
